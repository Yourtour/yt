 ...
 * @since 1.0
 */
public interface RelationshipCrudOperate<T extends Neo4jBaseBean> {
	 ...
	 *             获取过程中发生的异常
	 */
	public long count(Class<T> clazz) throws Exception;
	 ...
	 *             获取过程中发生的异常
	 */
	public T get(Class<T> clazz, Long graphId) throws Exception;
	 ...
	 *             获取过程中发生的异常
	 */
	public T get(Class<T> clazz, Long graphId, boolean loadRelations) throws Exception;
	 ...
	 *             获取过程中发生的异常
	 */
	public T get(Class<T> clazz, String indexedPropertyName, String value) throws Exception;
	 ...
	 *             获取过程中发生的异常
	 */
	public T get(Class<T> clazz, String indexedPropertyName, String value, boolean loadRelations) throws Exception;
	 ...
	 *             获取过程中发生的异常
	 */
	public List<T> get(Class<T> clazz) throws Exception;
	 ...
	 *             获取过程中发生的异常
	 */
	public List<T> get(Class<T> clazz, boolean loadRelations) throws Exception;
	 ...
	 *             获取过程中发生的异常
	 */
	public List<T> getByPage(Class<T> clazz, int start, int limit)	throws Exception;
	 ...
	 *             获取过程中发生的异常
	 */
	public List<T> getByPage(Class<T> clazz, int start, int limit, boolean loadRelations) throws Exception;
	 ...
	 *             保存过程中发生的异常
	 */
	public void saveRelationsOnly(T neo4jBean,
	 ...
	 *             删除关系过程中发生的异常
	 */
	public void deleteRelation(Neo4jBaseBean src, String relationship) throws Exception;
}
