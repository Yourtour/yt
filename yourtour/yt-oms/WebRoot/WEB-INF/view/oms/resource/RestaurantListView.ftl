<div id="Page_RestaurantListView" class="row" data-role="page">
    <div class="col-lg-12">
        <div class="page-bar">
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <table id="datatable_restaurant" class="row-border" cellspacing="0" width="100%"  data-rest="${context}/rest/oms/resources/restaurants/query">
                            <thead>
                                <tr>
                                    <th>
