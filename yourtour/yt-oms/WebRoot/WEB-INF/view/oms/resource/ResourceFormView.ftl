...
<div class="form-group">
    ...
    <div class="col-md-10">
        <textarea class="form-control" name="bookingMemo" id="bookingMemo" rows="3" placeholder="预订须知"></textarea>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-10">
        <textarea class="form-control" name="tips" id="tips" rows="3" placeholder="旅行贴士"></textarea>
    </div>
</div>
