<div id="Page_BannerListView" class="row" data-role="page">
    <div class="col-lg-12">
        <div class="page-bar">
            ...
            <div class="col-md-12">
                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <table id="datatable_banner" class="row-border" cellspacing="0" width="100%"  data-rest="${context}/rest/oms/banners/query">
                            <thead>
                                <tr>
                                    <th>
