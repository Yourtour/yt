Ext.define('YourTour.view.home.AlongDetailView', {
    ...
    requires:['Ext.DataView', 'Ext.Toolbar', 'YourTour.view.home.AlongListItemView', 'YourTour.view.common.CommentListDataItem', 'YourTour.view.widget.XHeaderBar','YourTour.view.widget.XField','YourTour.view.widget.XLabel'],
    config: {
    	id:'AlongDetailView',
        items: [
			{    
