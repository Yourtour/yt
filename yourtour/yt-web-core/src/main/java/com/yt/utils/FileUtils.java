...
public class FileUtils implements ApplicationContextAware{
	 ...
	 * @throws Exception
	 */
	public static String saveFile(String relativePath, String type, InputStream is) throws Exception{
		...
		relativePath =  File.separator  + relativePath + File.separator + date;
		...
		saveFile(relativePath + File.separator + fileName, is);
	...
	private static String getUploadBase(){
		return 	StringUtils.isNull(uploadBase)?ContextLoaderListener.realpath:uploadBase;
	}

	@Override
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		if(applicationContext.containsBean("configProperties")){
			PropertiesReader configProperties = applicationContext.getBean(PropertiesReader.class);
