...
import com.yt.common.Constants.ScheduleType;
...
public class RouteScheduleBean extends BaseBean {
	...
	private 	@HbaseColumn(name = "addr")		String 	Address; 	//地址信息
	private 	@HbaseColumn(name = "pos")		String 	position; 	//位置信息
	private 	@HbaseColumn(name = "type")		ScheduleType 	type; 	//安排类型
	private 	@HbaseColumn(name = "img")		String 	imageUrl; 	//行程图片
	...
	//提醒设置
	private	@HbaseColumn(name = "alta")		int		alertable;		//是否提醒
	private	@HbaseColumn(name = "altt")		long	alertTime;		//提醒时间
